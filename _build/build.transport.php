<?php
/**
 * mspvictoriabankmd build script
 *
 * @package mspvictoriabankmd
 * @subpackage build
 */
$mtime = microtime();
$mtime = explode(' ', $mtime);
...
$sources = array(
	...
	'source_assets' => array(
		'components/minishop2/payment/victoriabankmd.php'
	),
	'source_core' => array(
		'components/minishop2/custom/payment/victoriabankmd.class.php',
		'components/minishop2/lexicon/en/msp.victoriabankmd.inc.php',
		'components/minishop2/lexicon/ru/msp.victoriabankmd.inc.php',
		'components/minishop2/custom/payment/lib/victoriabankmd/victoria_pub.pem'
	)
	,'docs' => $root . 'docs/'
);
